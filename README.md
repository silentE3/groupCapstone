...
The read-report command reads in a given previously generated report. Ensure that the **reportfile** is the excel file generated by the report command. We should be able to read
into a report based on a given report excel file.

1. **reportfile**: the first required parameter for the read-report command. This should be a valid report file in excel generated by the report command. 
