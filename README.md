...
#Eventually, we should be able to generate the report whenever we use the group command, and that the report name should be similar to the input file name.
#
