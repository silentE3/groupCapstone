...
def test_generate_preferred_pairs_per_group():
    ...
    group1 = models.GroupRecord("1",
                                [models.SurveyRecord("a1", preferred_students=["a2", "a3"]),
                                 models.SurveyRecord(
                                     "a2", preferred_students=["a1", "a3"]),
                                    models.SurveyRecord("a3",  preferred_students=["a1", "a2"])])

    group2 = models.GroupRecord("2",
                                [models.SurveyRecord("a4", preferred_students=["a5"]),
                                 models.SurveyRecord(
                                     "a5", preferred_students=["a6", "a8"]),
                                    models.SurveyRecord("a6", preferred_students=["a7"])])
