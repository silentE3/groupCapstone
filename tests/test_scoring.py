...
def test_scoring_groups_1():
    ...
    setdata = models.GroupSetData("group1", 0, 2, 300, 175, 5, 3, 100, 8)
...
def test_scoring_groups_2():
    ...
    # target group size = 5, preferred slots on survey = 3, number of students = 100, time slots on survey = 8
    # Note: This means max num groups possible = 25
    setdata = models.GroupSetData("group1", 25, 1, 0, 0, 5, 3, 100, 8)
...
def test_scoring_groups_3():
    ...
    setdata = models.GroupSetData("group1", 100, 1, 0, 0, 0, 3, 100, 8)
...
def test_scoring_single_group_1():
    ...
    set_vars = models.GroupSetData(group.group_id, 0, 0, 0, 0, 2, 2, 7, 6)
...
def test_scoring_single_group_3():
    ...
    set_vars = models.GroupSetData(group.group_id, 0, 0, 0, 0, 3, 3, 10, 4)
...
def test_standard_dev_groups():
    ...
    set_vars = models.GroupSetData("group_solution", 0, 0, 0, 0, 2, 2, 7, 6)
