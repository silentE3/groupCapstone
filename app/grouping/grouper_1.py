...
class Grouper1:
    ...
    def create_groups(self) -> list[models.GroupRecord]:
        ...
        with ThreadPoolExecutor() as executor:
            ...
            for grouping_pass in range(max(self.config_data["grouping_passes"], 1)):
                grouping_pass_inst = self.GroupingPass(self)
                # Steps 1 - 3
                futures.append(executor.submit(
                    grouping_pass_inst.start_grouping, grouping_pass, self.num_groups))
    ...
    class GroupingPass:
        ...
        def __init__(self, instance_grouper_1):
            self.groups = []
            self.instance_grouper_1 = instance_grouper_1

        def start_grouping(self, grouping_pass: int, num_groups: int):
            '''
